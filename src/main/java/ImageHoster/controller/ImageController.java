...
public class ImageController {
    ...
    public String newComment(@RequestParam("comment") String comment,
                             @PathVariable("title") String title, @PathVariable("id") Integer Id,
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if (isOwner(sessionUser, imageOwner)) {
          return "images/edit";
        } else {
    ...
    private boolean isOwner(User sessionUser, User imageOwner){
        if(sessionUser.getUsername().equalsIgnoreCase(imageOwner.getUsername()))
            return true;
        else
            return false;
    }
